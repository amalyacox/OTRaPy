...
class ProcessedData: 
    ...
    def add_raman_row(self,sample,date,path,spot_size_path, sample_image_path, 
                A, Aerr,pwr,dwdp,dwdp_err,w0=0,w0_err=0, l0=0,l0_err=0,
                aniso=True, parallel_to_wrinkles=True,notes=''):
        self.date=date
    ...
    def add_tdtr_row(self,sample,date,path,pump_spot_path, probe_spot_path, sample_image_path, 
                g, gerr,w0=0,w0_err=0, l0=0,l0_err=0,notes=''):
        self.date=date
        this_row = {'sample':sample,
                    'date':date,
                    'path':path,
